// Original procedural precinct portraits. These small symbolic designs use
// invented palettes and silhouettes; they are not derived from actor photos,
// screenshots, promotional art, or traced likenesses.
...
const RECIPES: Record<CharacterName, Recipe> = {
  holt:      { skin: 'brown', hairc: [34, 42, 52],   hair: 'styleShort', hairargs: { part: 'R' }, cloth: 'suit', c1: [48, 66, 86], tie: [104, 156, 176], brow: 'flat', mouth: 'neutral' },
  terry:     { skin: 'dark',  hairc: [36, 31, 38],   hair: 'styleSpiky', cloth: 'polo', c1: [66, 105, 142], c2: [186, 205, 214], brow: 'soft', mouth: 'smile', heavy: true },
  jake:      { skin: 'tan',   hairc: [38, 54, 72],   hair: 'styleMessy', hairargs: { length: 9 }, cloth: 'dressshirt', c1: [78, 126, 158], tie: [224, 154, 72], brow: 'raised', mouth: 'grin' },
  amy:       { skin: 'brown', hairc: [58, 38, 68],   hair: 'styleBun', cloth: 'cardigan', c1: [122, 96, 150], c2: [226, 215, 196], glasses: true, brow: 'soft', mouth: 'smile', lashes: true },
  rosa:      { skin: 'tan',   hairc: [29, 35, 47],   hair: 'styleFrame', hairargs: { length: 17 }, cloth: 'suit', c1: [55, 54, 68], tie: [146, 77, 91], brow: 'angry', mouth: 'neutral' },
  charles:   { skin: 'light', hairc: [112, 78, 53],  hair: 'styleCurly', cloth: 'sweater', c1: [139, 96, 69], brow: 'soft', mouth: 'smile' },
  gina:      { skin: 'dark',  hairc: [74, 35, 62],   hair: 'styleFrame', hairargs: { length: 20, vol: 2 }, cloth: 'blouse', c1: [164, 74, 120], brow: 'raised', mouth: 'grin', lashes: true },
  hitchcock: { skin: 'light', hairc: [91, 101, 111], hair: 'styleRecede', cloth: 'dressshirt', c1: [126, 105, 74], tie: [73, 112, 107], glasses: true, brow: 'flat', mouth: 'neutral', heavy: true },
  scully:    { skin: 'tan',   hairc: [112, 118, 109], hair: 'styleBald', cloth: 'cardigan', c1: [100, 128, 104], c2: [229, 218, 186], facial: 'mustacheSm', brow: 'soft', mouth: 'smile', heavy: true },
};
...
function getBuf(name: CharacterName): Buf {
  ...
  if (!buf) {
    buf = compose(RECIPES[name] ?? RECIPES.jake);
...
export function sceneFrameBufs(name: CharacterName): SceneFrames {
  ...
  if (!frames) {
    const r = RECIPES[name] ?? RECIPES.jake;
    frames = {
