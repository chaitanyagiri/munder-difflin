      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 220, fontSize: 12, color: 'var(--cth-ink-700)', lineHeight: 1.5 }}>
          {missingEssential.length
            ? <>Captain Holt can install the {missingEssential.length} missing recommended {missingEssential.length === 1 ? 'tool' : 'tools'} for you. This fills in command's dispatch box — nothing runs until you press dispatch.</>
        ...
        >
          <span style={{ display: 'inline-flex', gap: 4, alignItems: 'center' }}>
            <Icon name="sparkle" /> ask Captain Holt to set up everything
          </span>
        </PixelButton>
      </div>
